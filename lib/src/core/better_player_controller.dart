...
class BetterPlayerController {
  ...
  void toggleControlsVisibility(bool isVisible) {
    _postEvent(
      isVisible
          ? BetterPlayerEvent(BetterPlayerEventType.controlsVisibleEnd)
      ...
      _postEvent(
        BetterPlayerEvent(
          ...
          parameters: <String, dynamic>{
            ...
            'errorMessage': currentVideoPlayerValue.errorMessage,
            'errorCode': currentVideoPlayerValue.errorCode,
            'errorCodeName': currentVideoPlayerValue.errorCodeName,
          },
        ),
      );
    }
      ...
      case VideoEventType.bufferingUpdate:
        _postEvent(
          BetterPlayerEvent(
            ...
            parameters: <String, dynamic>{_bufferedParameter: event.buffered},
          ),
        );
